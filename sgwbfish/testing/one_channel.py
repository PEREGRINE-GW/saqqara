...
np.save("AA_alpha_sensivities.npy", alpha_sensivities)
np.save("AA_beta_sensivities.npy", beta_sensivities)
...
if True:
    ...
    plt.savefig(os.path.dirname(__file__) + "/../plots/AA_minus11_sensitivity.png")
